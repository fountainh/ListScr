...
public class BidsDBAdapter {
 ...
 private static final String SQLITE_TABLE = "AppTraderBids2";
 ...
 public BidsDBAdapter(Context ctx) {
  this.mCtx = ctx;
 }
 
 public BidsDBAdapter open() throws SQLException {
