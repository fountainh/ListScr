...
public class BidPostings extends Activity {
...
public void onCreate(Bundle savedInstanceState) {
	  ...
	  button.setOnClickListener(new View.OnClickListener() {
	      ...
	      public void onClick(View v) {
	    	  ...
	    	  dbHelper.insertAbid("Raman","Mike","2345","02132013",title_str,description_str,budget_str,date_str);
	    	 
	    	  
	    	   
	    	  Cursor jobCursor=dbHelper.fetchAllbids();
